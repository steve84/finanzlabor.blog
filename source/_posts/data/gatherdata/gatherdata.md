...
Diese Informationen sind so lange auf dem aktuellsten Stand, bis ein Unternehmen neue Daten veröffentlicht. Mit einer API würde die Möglichkeit bestehen (sofern der Anbieter diese Funktionalität zur Verfügung stellt), die neusten Kennzahlen für genau dieses jederzeit zu beziehen.
...
[^1]: [Dev Insider: Was ist RES API?](https://www.dev-insider.de/was-ist-rest-api-a-667357)
